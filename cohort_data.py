def unique_houses(filename):
    ...
    with open(filename) as in_file:
        ...
        # ["Alena", "k", "Gry", "Cynthia", "Spring 2015"]
            if line_split[2]:
                houses.add(line_split[2]) 
...
def sort_by_cohort(filename):
    ...
    with open(filename) as in_file:
        for line in in_file:
            ...
            if line_split[4] == 'TA':
                tas.append(line_split[0])
                print tas 

            elif line_split[4] == 'Winter 2015':
                winter_15.append(line_split[0])
                
                print winter_15

            elif line_split[4] == 'Spring 2015':
                spring_15.append(line_split[0])
                
                print spring_15

            elif line_split[4] == 'Summer 2015':
                summer_15.append(line_split[0])
